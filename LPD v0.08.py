...
if cont==0:
    where_next=int(input("You walk || 1. Nowhere  2. [to be added]  3. [to be added]  4. [to be added]  5. Out of town :"))
    if where_next==1:
        ...
        if fake_it>0:
                ...
                ques=int(input("Ask the traveler... 1. Their name  2. Their business  3. Who they think they are walking up to YOUR bar without cash in their hand ||: "))
                if ques==1:
                    print("Traveler: John")
                if ques==2:
        ...
        where_next=int(input("You walk ||1. Inside the bar 2. [to be added]  3. [to be added]  4. [to be added]  5. Out of town :"))
        if where_next==1:
            cont=1
        if cont==1:
            print("You swing the doors open and step inside...")
...
#    walkpast=int(input("Walk past the 16 5-seat tables of patrons to || 5:The left stairwell  6:The Bar  7:A Table  8:The right stairwell ||"))
    ...
    if where_next==5:
        ...
        where_next=int(input("Where to?... 1. [to be added] | 2. Center left [No content] | 3. Center right | 4. [to be added]"))
        if where_next==3:
            ...
            if leave==0:
                ...
                action=int(input("1= Say something || 2= Do karate || 3. Laugh at the gremlin for living in trees like some sort of bird"))

                if action==1:
                    print("What do you tell the gremlins?")
                    input()
                if action==2:
                    print("You get into a fighting stance, with both fists at your sides.")
                    print()
                    karate_skill=karate_skill+3
                    print("The first gremlin approaches, slowly, with murder in its gaze...")
                    k_move=int(input("It's close enough. Unleash: 1. A kick to the face || 2. A punch to the jugular || 3. A gun"))
                    if k_move==1:
                        print("You rear back and kick the gremlin right in its mangled teeth...")
                        print("The gremlin SNARLS")
                        print("The rest are stunned, retreating into the trees...")
                    if k_move==2:
                        print("As the gremlin jumps at your face, your fist connects right into the monster's throat.")
                        print("The small abomination gasps for air, its windpipe clearly crushed by the might of the human fist.")
                        print("The rest retreat into the trees, not wanting to tempt their own fate...")
                        print("The gremlins are gone.")
                    if k_move==3:
                        shots=int(input("How many shots do you loose from the weapon?"))
                        if shots>1:
                            print("The gremlins see you draw and freeze.")
                            print("You fire into the first one, killing it instantly. The others turn and run as fast and as far as they can as your bullets fly past them, dipping and dodging between the trees")
                            print("The gremlins are gone.")
                        if shots==1:
                            print("The first gremlin drops. The rest recoil into cover, watching for your next move")
                            print("They seem to think better of attacking you.")
                            print("The gremlins disappear into the many trees, behind many rocks, and into the canopy above.")
                            print("The gremlins are gone.")
                        if shots==0 or shots<1:
                            print("The gremlins freeze. They know this technology.")
                            print("Gremlin: Just you wait, Traveller! We'll see you without that fancy piece sometime!")
                            print("You walk cautiously past the gremlin turf, one eye always scanning any possible hiding spots...")
                            print("You have escaped the gremlins' wrath; for now...")
                if action==3:
                    print("Gremlin: How dare you! This forrest is oursss!!")
                    print("The gremlins all yeowl and roar, leaping forth from the branches...")
                    print("")

print("You continue down the path, walking towards an opening in the trees barely noticable among the dark net of leaves and branches that seem so safe and yet so trapping...")
print("You come out the other end of the forrest, and see a large city with a grand castle inset just a couple hundred meters behind the messy rows of wodden buildings and thatched rooves.")
print("There is a permanent-looking bridge over the moat. Cross? (Choice does not actually work)")
input("00/01: ")
print("The bridge creaks under your feet as you cross it, the whole structure's solid enough even despite the slight wobble. This thing has been here a while.")
print("You reach a guard gate.")
print("Guard: Who are you?")
